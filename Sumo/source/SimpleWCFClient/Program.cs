...
using SimpleWCFClient.ITestingServise;
using SimpleWCFClient.ServiceReference1;
//using Sumo.API;
using Sumo.API;
using CategoriesMultiList = SimpleWCFClient.ITestingServise.CategoriesMultiList;
...
namespace SimpleWCFClient
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var proxy = new ServiceReference2.TestingServiceClient(binding, endpointAddress);
