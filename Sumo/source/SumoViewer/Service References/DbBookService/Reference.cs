...
namespace SumoViewer.DbBookService {
    ...
    public partial class CategoriesMultiList : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private System.Collections.Generic.List<SumoViewer.DbBookService.CategoriesMultiList> ChildsField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private SumoViewer.DbBookService.CategoryNode NodeField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public System.Collections.Generic.List<SumoViewer.DbBookService.CategoriesMultiList> Childs {
            get {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public SumoViewer.DbBookService.CategoryNode Node {
            get {
    ...
    public interface IDbMetaManager {
        ...
        SumoViewer.DbBookService.SumoSession CreateQuery(string query);
        ...
        System.Collections.Generic.List<SumoViewer.DbBookService.Book> GetDocuments(int sessionId, int count, int offset);
        ...
        SumoViewer.DbBookService.CategoriesMultiList GetStatistic(int sessionId);
        ...
        void CloseSession(SumoViewer.DbBookService.SumoSession session);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IDbMetaManagerChannel : SumoViewer.DbBookService.IDbMetaManager, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class DbMetaManagerClient : System.ServiceModel.ClientBase<SumoViewer.DbBookService.IDbMetaManager>, SumoViewer.DbBookService.IDbMetaManager {
        ...
        public SumoViewer.DbBookService.SumoSession CreateQuery(string query) {
            return base.Channel.CreateQuery(query);
        }
        
        public System.Collections.Generic.List<SumoViewer.DbBookService.Book> GetDocuments(int sessionId, int count, int offset) {
            return base.Channel.GetDocuments(sessionId, count, offset);
        }
        
        public SumoViewer.DbBookService.CategoriesMultiList GetStatistic(int sessionId) {
            return base.Channel.GetStatistic(sessionId);
        }
        
        public void CloseSession(SumoViewer.DbBookService.SumoSession session) {
